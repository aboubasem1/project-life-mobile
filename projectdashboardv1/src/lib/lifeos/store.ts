...
export function normalizeCapture(raw: unknown): Capture | null {
  ...
  return {
    ...
    fileObjectId: asOptionalString(item.fileObjectId),
    fileStorageKey: asOptionalString(item.fileStorageKey),
    fileContentType: asOptionalString(item.fileContentType),
