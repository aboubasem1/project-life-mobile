...
allowed_key() {
  case "$1" in
    ...
    UPSTASH_REDIS_REST_URL|UPSTASH_REDIS_REST_TOKEN|SYNC_UPSTASH_BRIDGE|OPENAI_API_KEY|\
    LLM_API_KEY|LLM_API_URL|LLM_MODEL|LLM_TIMEOUT_MS|\
    TRANSCRIPTION_API_KEY|TRANSCRIPTION_API_URL|TRANSCRIPTION_ENABLED|\
    TRANSCRIPTION_LANGUAGE|TRANSCRIPTION_MODEL|TRANSCRIPTION_TIMEOUT_MS|\
